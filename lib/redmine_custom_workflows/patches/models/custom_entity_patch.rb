    ...
    module Models
      ...
      module CustomEntityPatch
        ...
        def before_destroy_custom_workflows
          res = CustomWorkflow.run_custom_workflows(:custom_entity, self, :before_destroy)
...
if Redmine::Plugin.installed?('easy_extensions')
  RedmineExtensions::PatchManager.register_model_patch 'CustomEntity',
                                                       'RedmineCustomWorkflows::Patches::Models::CustomEntity'
else
  CustomEntity.prepend RedmineCustomWorkflows::Patches::Models::CustomEntityPatch
end
