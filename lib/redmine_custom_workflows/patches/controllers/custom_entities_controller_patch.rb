...
module RedmineCustomWorkflows
  module Patches
    module Controllers
      # CustomEntity controller patch
      module CustomEntitiesControllerPatch
        def self.prepended(base)
          base.class_eval do
            before_action :set_env, only: %i[create update destroy]
            after_action :display_custom_workflow_messages, only: %i[create update destroy]
          end
        end
...
CustomEntitiesController.prepend RedmineCustomWorkflows::Patches::Controllers::CustomEntitiesControllerPatch
